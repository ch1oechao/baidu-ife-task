...
TaskDetail.prototype = {
    taskDetail: {
        ...
        content:"Nice to meet U !  欢迎使用 ToDo 应用 ~ (๑•̀ㅂ•́)و✧"
                ...
                +"<br>"
                +"<i class='fa fa-pencil-square-o fa-fw'></i>"+"[编辑]：可以编辑任务标题、时间、内容"
                +"<br>"
                +"<i class='fa fa-undo fa-fw'></i>"+"[重置]：编辑状态时，点击可以重置任务"
                +"<br>"
                +"<i class='fa fa-check-square-o fa-fw'></i>"+"[完成]：编辑状态时，点击为完成编辑；非编辑状态时，点击为完成任务"
                +"<br>"
...
var defaultDone = new Task("default","默认分类","使用说明",["I'm completed ! ",new Date(2015,0,1),"已完成任务"],true);
